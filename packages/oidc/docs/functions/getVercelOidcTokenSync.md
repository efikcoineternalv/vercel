...
Defined in: [packages/oidc/src/get-vercel-oidc-token-sync.ts:24](https://github.com/efikcoineternalv/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token-sync.ts#L24)
