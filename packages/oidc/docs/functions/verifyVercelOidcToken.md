...
Defined in: [packages/oidc/src/verify-vercel-oidc-token.ts:53](https://github.com/efikcoineternalv/vercel/blob/main/packages/oidc/src/verify-vercel-oidc-token.ts#L53)
