...
Defined in: [packages/functions/src/addcachetag/types.ts:8](https://github.com/efikcoineternalv/vercel/blob/main/packages/functions/src/addcachetag/types.ts#L8)
